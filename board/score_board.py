...
class ScoreBoard:
    ...
    def get_remaining_time(self, start_ticks):
        ...
        self.remaining_time = TIMER_DURATION - elapsed_time + self._time_penalty
        return self.remaining_time

    def get_time_text(self):
        return self._font.render(f"Time left: {self.remaining_time:.1f}s", True, RED_COLOR)

    def get_score_text(self):
        return self._font.render(f"Score: {int(self.score)}", True, WHITE_COLOR)
    ...
    def increment_remaining_time(self):
        self._time_penalty += PLUS_SECOND_FOR_STINKY_BUG

    def decrement_remaining_time(self):
        self._time_penalty -= MINUS_SECOND_FOR_BEE
